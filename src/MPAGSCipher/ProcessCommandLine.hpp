 ...
 * \exception MissingArgument will be emitted if the an argument is not supplied where
 *            it is required.
 * \exception UnknownArgument will be emitted if the an unknown argument is not supplied.
 */
